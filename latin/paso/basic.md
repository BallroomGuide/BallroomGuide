...
|---|---|---|---|---|
| 1 | RF fwd, small step |  | Facing Wall | Wall |
| 2 | LF fwd, small step |  | Facing Wall | Wall |
| 3 | RF fwd, small step |  | Facing Wall | Wall |
| 4 | LF fwd, small step |  | Facing Wall | Wall |
...
Commence in Closed Position with Closed Hold, backing Wall
 ...
 | **Step<span style="color:white">\_</span>\#** | **Steps** | **Turn** | **Alignment** | **Moving** |
|---|---|---|---|---|
| 1 | LF back, small step |  | Backing Wall | Wall |
| 2 | RF back, small step |  | Backing Wall | Wall |
| 3 | LF back, small step |  | Backing Wall | Wall |
| 4 | RF back, small step |  | Backing Wall | Wall |
...
Commence in Closed Position with Closed Hold, facing Wall
 ...
 | **Step<span style="color:white">\_</span>\#** | **Steps** | **Turn** | **Alignment** | **Moving** |
|---|---|---|---|---|
| 1 | RF back, small step |  | Backing Centre | Centre |
| 2 | LF back, small step |  | Backing Centre | Centre |
| 3 | RF back, small step |  | Backing Centre | Centre |
| 4 | LF back, small step |  | Backing Centre | Centre |
...
Commence in Closed Position with Closed Hold, backing Wall
 ...
 | **Step<span style="color:white">\_</span>\#** | **Steps** | **Turn** | **Alignment** | **Moving** |
|---|---|---|---|---|
| 1 | LF fwd, small step |  | Facing Centre | Centre |
| 2 | RF fwd, small step |  | Facing Centre | Centre |
| 3 | LF fwd, small step |  | Facing Centre | Centre |
| 4 | RF fwd, small step |  | Facing Centre | Centre |
...
### Follows to the Basic (Forward or Back) When Ended in Promenade Position
...
| Silver | 3-16 [La Passe](la_passe.md); 3-8 [Twist Turn](twist_turn.md); [Coup de Pique](coup_de_pique.md); [Spanish Line in Inverted CPP](spanish_lines.md) |
