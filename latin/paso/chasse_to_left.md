...
| 2 | LF to side |  | Facing Wall | LOD |
| 3 | RF closes to LF |  | Facing Wall | Under Body |
| 4 | LF to side |  | Facing Wall | LOD |
...
Commence in Closed Position with Closed Hold, backing Wall
 ...
 | **Step<span style="color:white">\_</span>\#** | **Steps** | **Turn** | **Alignment** | **Moving** |
|---|---|---|---|---|
| 1 | Appel on LF |  | Facing Centre | Under Body |
| 2 | RF to side |  | Facing Centre | LOD |
