...
|---|---|---|---|---|
| 1 | 2 | LF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | LSP | 1/8 to R before 1 |
| 2 | &amp; | Replace weight to RF | LSP |  |
| 3 | 3 | LF to side | Closed | 1/4 to L between 2-3 |
| 4 | &amp; | Replace weight to RF | Closed |  |
| 5 | 4 | LF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | LSP | 1/4 to R between 4-5 |
| 6 | &amp; | Replace weight to RF | LSP |  |
| 7 | 1 | LF to side | Closed | 1/4 to L between 6-7 |
...
1\) May be danced without turn over steps 1-6, turning 1/8 to L to face partner on step 7, with or without hold  
 ...
 3) May be danced as a part of the [Time Step Challenge](time_step.md#challenge)  
...
### Lady
 ...
 | **Step<span style="color:white">\_</span>\#** | **Count** | **Steps** | **Position** | **Turn** |
|---|---|---|---|---|
| 1 | 2 | RF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | LSP | 1/8 to L before 1 |
| 2 | &amp; | Replace weight to LF | LSP |  |
| 3 | 3 | RF to side | Closed | 1/4 to R between 2-3 |
| 4 | &amp; | Replace weight to LF | Closed |  |
| 5 | 4 | RF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | LSP | 1/4 to L between 4-5 |
| 6 | &amp; | Replace weight to LF | LSP |  |
| 7 | 1 | RF to side | Closed | 1/4 to R between 6-7 |
...
|  |  |
| **Commenced in Closed Position** | **Having released hold at the end of the previous figure, making no turn throughout the Cuban Break** |
| PreBronze | [Closed Basic](closed_basic.md); [New York to RSP](new_york.md); [Spot Turn to L (Lady to R)](spot_turn.md); [Underarm Turn to R](underarm_turn.md); [R Side Shoulder to Shoulder](shoulder_to_shoulder.md); [Hand to Hand to LSP](hand_to_hand.md); [Side Steps to R commenced with RF](side_step.md); [Time Step](time_step.md) |
| Silver | [RF Cuban Break](cuban_breaks.md); [Split Cuban Break commenced with LF](cuban_breaks.md) |
|  |  |
| **Commenced in LSP** | **Having maintained LSP from the previous figure, making no turn between the last step of the previous figure and step 1 of the LF Cuban Break** |
...
|  |  |
| **Ended in Open PP** | **Man turns an additional 1/8 to L (Lady to R) between steps 6-7** |
...
-----------------------------
 ...
 | **Step<span style="color:white">\_</span>\#** | **Count** | **Steps** | **Position** | **Turn** |
|---|---|---|---|---|
| 1 | 2 | RF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | RSP | 1/8 to L before 1 |
| 2 | &amp; | Replace weight to LF | RSP |  |
| 3 | 3 | RF to side | Closed | 1/4 to R between 2-3 |
| 4 | &amp; | Replace weight to LF | Closed |  |
| 5 | 4 | RF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | RSP | 1/4 to L between 4-5 |
| 6 | &amp; | Replace weight to LF | RSP |  |
| 7 | 1 | RF to side | Closed | 1/4 to R between 6-7 |
...
### Lady
 ...
 | **Step<span style="color:white">\_</span>\#** | **Count** | **Steps** | **Position** | **Turn** |
|---|---|---|---|---|
| 1 | 2 | LF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | RSP | 1/8 to R before 1 |
| 2 | &amp; | Replace weight to RF | RSP |  |
| 3 | 3 | LF to side | Closed | 1/4 to L between 2-3 |
| 4 | &amp; | Replace weight to RF | Closed |  |
| 5 | 4 | LF fwd and across ([Checked Fwd Walk](../technique/cr_checked_fwd_walk.md)) | RSP | 1/4 to R between 4-5 |
| 6 | &amp; | Replace weight to RF | RSP |  |
| 7 | 1 | LF to side | Closed | 1/4 to L between 6-7 |
...
| Silver | 1-5 [Cross Basic](cross_basic.md); [LF Cuban Break](cuban_breaks.md); [Split Cuban Break commenced with RF](cuban_breaks.md) |
|  |  |
| **Commenced in RSP** | **Having maintained RSP from the previous figure, making no turn between the last step of the previous figure and step 1 of the RF Cuban Break** |
...
| Bronze | [Fan](fan.md) |
| Silver | [Reverse Top](reverse_top.md) (from step 6); [Cross Basic](cross_basic.md); [Rope Spinning](rope_spinning.md) |
|  |  |
| **Ended in Open CPP** | **Man turns an additional 1/8 to R (Lady to L) between steps 6-7** |
...
| Silver | [LF Cuban Break](cuban_breaks.md); [Split Cuban Break commenced with LF](#split) |